...
if (
  ...
  process.env.REVIEW_SEED_CONFIRM !== "isolated"
) {
...
const industry = await upsert("categories", "dating-social-networking", {
  name: "Dating & Social Networking",
});
const types = [
...
const entries = [
  {
    key: "leslie",
    title: "Bumble: First date bowling vlog",
    source: "34389d7a-9bc6-4d87-acb5-d63d310d4e6b",
  },
  {
    key: "sebas",
    title: "Bumble: Arcade first date",
    source: "de711b90-5760-401d-94cd-8641edafbcef",
  },
  {
    key: "kirsten",
    title: "Bumble: Thrifting first date",
    source: "dae32bbd-15ad-454b-9af3-29b0e1d69edd",
  },
];
